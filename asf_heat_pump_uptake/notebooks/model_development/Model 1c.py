...
#
# In this model, we refactor the upfront environment variable code to include a deflation factor so that the cost of a new heat source installation falls over time relative to model initiation costs.
...
# %%
upfront_costs["gas_boiler_upfront"] * (upfront_costs["gas_boiler_upfront_rate"] ** 19)

# %%
HeatPump.name.lower().replace(" ", "_") + "_upfront"
